...
class BoletoView extends TPage
{
    public function onGenerate($param)
    {
        ...
        $dadosboleto["cpf_cnpj"] = "92.457.324/0001-71";
        $dadosboleto["endereco"] = "Rua Ângelo Uglione, 1567. Bairro Centro - Cep 88.888-888";
        $dadosboleto["cidade_uf"] = "Santa Maria - RS";
        $dadosboleto["cedente"] = "Condomínio Edifício Cinema Glória";
        ob_start();
